    ...
    return (
        <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-between items-end gap-4 py-4 mb-2">
                ...
                <button className="rounded-lg h-10 px-6 bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold leading-normal tracking-[0.015em] transition-colors shadow-sm gap-2 flex justify-center items-center cursor-pointer">
                    <span>+</span>
